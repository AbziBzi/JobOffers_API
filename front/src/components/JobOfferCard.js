...
function JobOfferCard(props) {
  ...
  return (
    <Link className={classes.link} to={{ pathname: `/jobs/${props.offer.id}`, state: { offer: props.offer, company: props.company, experience: props.experience } }} key={props.offer.id}>
      <Card>
        <Box display="flex"
